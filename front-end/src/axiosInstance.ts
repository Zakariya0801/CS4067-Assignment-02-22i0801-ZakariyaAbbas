...
const axiosInstance = axios.create({
  ...
  //baseURL: "https://purpose-write-backend.onrender.com/api", // Update with your backend's base URL
  // baseURL: "https://aistudio.se/api", // Update with your backend's base URL
  headers: {
